...
// Check if user is logged in
    ...
    if(isset($_POST["save_changes"])) {
        $user_loggedin = $_SESSION['id'];
        $sql_password = "SELECT password FROM `users-table` WHERE id = $user_loggedin";
...
<body>
    ...
    <form action="" method="POST">
        <section class="section text-center">
            ...
            <div class="container mt-4 p-4 bg-light rounded-2 text-start">
                <?php
                    $id = $_SESSION['id'];
                ...
                ?>
                    <div class="form-group d-flex flex-column align-items-center">
                        ...
                        <div class="fw-bold fs-2 pb-4"><?php echo $row ["full_name"] ?></div>                 
                    </div>
                    <div class="row">
                    ...
                    <div class="text-end pt-2">
                        <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#confirm-modal">Save Changes</button>
                    ...
                    <div class="modal-content p-3">
                        <div class="modal-body"> 
                            <div class="form-group mb-3">
                                <label for="password" class="form-label text-success fw-bold">Enter Password:</label>
                                <input type="password" class="form-control" id="password" name="password" required> 
                            </div>
                            <div class="text-end mt-3">
                                <button type="submit" id="save_changes" name="save_changes" class="btn btn-outline-success">Submit</button>
